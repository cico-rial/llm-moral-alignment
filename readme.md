# llm-alignment
General rule: clone repo, **create your own branch**, possibly work on separate file at this stage.  
I would suggest to copy the notebook files with your own version or create new ones.  
## how to set up:
- clone repo;
